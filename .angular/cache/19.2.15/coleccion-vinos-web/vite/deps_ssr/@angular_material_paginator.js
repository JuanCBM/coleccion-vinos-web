...
import {
  SelectionModel
} from "./chunk-IGOX76MO.js";
import {
  MatButtonModule,
  MatIconButton,
  MatRipple,
  MatRippleModule
} from "./chunk-3FDEQVGJ.js";
import {
  _StructuralStylesLoader
} from "./chunk-YYDWDDXB.js";
import {
  CdkConnectedOverlay,
  CdkOverlayOrigin,
  ComponentPortal,
  Overlay,
  OverlayModule
} from "./chunk-H5CX2WNH.js";
import {
  CdkScrollableModule,
  ScrollDispatcher,
  ViewportRuler
} from "./chunk-B33P5P2F.js";
import "./chunk-BABSEUN5.js";
import {
  coerceBooleanProperty
} from "./chunk-YU2YHX6P.js";
import {
  A,
  A11yModule,
...
function composeAsync(validators) {
  ...
  return function(control) {
    ...
    return (0, import_rxjs3.forkJoin)(observables).pipe((0, import_operators3.map)(mergeErrors));
  };
}
...
var MatSelect = class _MatSelect {
  ...
  optionSelectionChanges = (0, import_rxjs5.defer)(() => {
    ...
    if (options) {
      return options.changes.pipe((0, import_operators4.startWith)(options), (0, import_operators4.switchMap)(() => (0, import_rxjs5.merge)(...options.map((option) => option.onSelectionChange))));
    }
  ...
  _resetOptions() {
    ...
    (0, import_rxjs5.merge)(...this.options.map((option) => option._stateChanges)).pipe((0, import_operators4.takeUntil)(changedOrDestroyed)).subscribe(() => {
      this._changeDetectorRef.detectChanges();
      this.stateChanges.next();
    });
  }
...
var TooltipComponent = class _TooltipComponent {
  ...
  _onHide = new import_rxjs6.Subject();
...
var MatPaginatorIntl = class _MatPaginatorIntl {
   ...
   */
  changes = new import_rxjs7.Subject();
...
var MatPaginator = class _MatPaginator {
  ...
  _initializedStream = new import_rxjs7.ReplaySubject(1);
  /**
